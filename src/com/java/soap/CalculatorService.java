 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://soap.java.com/", wsdlLocation = "http://localhost:8085/ws/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://soap.java.com/", "CalculatorService");
    ...
    public CalculatorIfc getCalculatorPort() {
        return super.getPort(new QName("http://soap.java.com/", "CalculatorPort"), CalculatorIfc.class);
    }
    ...
    public CalculatorIfc getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.java.com/", "CalculatorPort"), CalculatorIfc.class, features);
    }
