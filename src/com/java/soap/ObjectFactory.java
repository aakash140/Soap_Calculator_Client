 ...
 * generated in the com.java.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://soap.java.com/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://soap.java.com/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://soap.java.com/", "multiply");
    private final static QName _Add_QNAME = new QName("http://soap.java.com/", "add");
    private final static QName _Subtract_QNAME = new QName("http://soap.java.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://soap.java.com/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://soap.java.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://soap.java.com/", "multiplyResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.java.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.java.com/", name = "multiplyResponse")
